...
def get_embedding(text: str) -> np.ndarray:
    # NEW: use client.embeddings.create instead of openai.Embedding.create
...
if channel_id:
    ...
    if st.button("🔍 Find Semantically Similar"):
        ...
        if not cand_ids:
            ...
            # 2) Fetch their details & compute embeddings
